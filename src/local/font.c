...
struct SystemFont systemFonts [SYSTEM_FONT_COUNT]= {
    {0,FONT_KEY_GOTHIC_14,"./systemFonts/gothic.ttf",8,14},
    {0,FONT_KEY_GOTHIC_14_BOLD,"./systemFonts/gothic-bold.ttf",8,14}, // 1 bold
    {0,FONT_KEY_GOTHIC_18,"./systemFonts/gothic.ttf",10,18},
    {0,FONT_KEY_GOTHIC_18_BOLD,"./systemFonts/gothic-bold.ttf",10,18}, // 3 bold
    {0,FONT_KEY_GOTHIC_24,"./systemFonts/gothic.ttf",14,24},
    {0,FONT_KEY_GOTHIC_24_BOLD,"./systemFonts/gothic-bold.ttf",14,24}, // 5 bold
    {0,FONT_KEY_GOTHIC_28,"./systemFonts/gothic.ttf",18,28},
    {0,FONT_KEY_GOTHIC_28_BOLD,"./systemFonts/gothic-bold.ttf",18,28}, // 7 bold
    {0,FONT_KEY_BITHAM_30_BLACK,"./systemFonts/bitham-black.ttf",30,30},
    {0,FONT_KEY_BITHAM_42_BOLD,"./systemFonts/bitham-bold.ttf",42,42}, // 9 bold
    {0,FONT_KEY_BITHAM_42_LIGHT,"./systemFonts/bitham-light.ttf",42,42},
    {0,FONT_KEY_BITHAM_42_MEDIUM_NUMBERS,"./systemFonts/bitham-medium-numbers.ttf",42,42},
    {0,FONT_KEY_BITHAM_34_MEDIUM_NUMBERS,"./systemFonts/bitham-medium-numbers.ttf",34,34},
    {0,FONT_KEY_BITHAM_34_LIGHT_SUBSET,"./systemFonts/bitham-light-subset.ttf",34,34},
    {0,FONT_KEY_BITHAM_18_LIGHT_SUBSET,"./systemFonts/bitham-light-subset.ttf",18,18},
    {0,FONT_KEY_ROBOTO_CONDENSED_21,"./systemFonts/roboto-condensed.ttf",21,21},
    {0,FONT_KEY_ROBOTO_BOLD_SUBSET_49,"./systemFonts/roboto-bold.ttf",49,49},
    {0,FONT_KEY_DROID_SERIF_28_BOLD,"./systemFonts/droid-serif-bold.ttf",28,28},
};
